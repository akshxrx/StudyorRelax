...
function thunderloadMusic(indexNumb){
  ...
  thundermainAudio.src = `../StudyorRelax/calm/sounds/thunder.mp3`;
}
...
thunderplayPauseBtn.addEventListener("click", ()=>{
  ...
  //   thunderpauseMusic();
  //   document.body.style.backgroundImage = "url('../StudyorRelax/calm/calm_pic/med-back.gif')";    //code for toggling the background image when pressed on the sound
  // } else {
  //   thunderplayMusic();
  //   document.body.style.backgroundImage = "url('../StudyorRelax/calm/calm_pic/thunder-back.gif')"; 
  // }
...
for (let i = 0; i < 1; i++) {
  ...
  let thunderliTag = `<li li-index="${i + 1}">
                ...
                <audio class="thunder" src="../StudyorRelax/calm/sounds/thunder.mp3"></audio>
              </li>`;
...
function cityloadMusic(){
  ...
  citymainAudio.src = `../StudyorRelax/calm/sounds/city.mp3`;
}
...
cityplayPauseBtn.addEventListener("click", ()=>{
  ...
  // if (cityisMusicPlay) {
  //   citypauseMusic();
  //   document.body.style.backgroundImage = "url('../StudyorRelax/calm/calm_pic/med-back.gif')"; 
  // } else {
  //   cityplayMusic();
  //   document.body.style.backgroundImage = "url('../StudyorRelax/calm/calm_pic/city-back.gif')"; 
  // }
...
for (let i = 0; i < 1; i++) {
  ...
  let cityliTag = `<li li-index="${i + 1}">
                ...
                <audio class="city" src="../StudyorRelax/calm/sounds/city.mp3"></audio>
              </li>`;
...
function oceanloadMusic(){
  ...
  oceanmainAudio.src = `../StudyorRelax/calm/sounds/ocean.mp3`;
}
...
for (let i = 0; i < 1; i++) {
  ...
  let oceanliTag = `<li li-index="${i + 1}">
                ...
                <audio class="ocean" src="../StudyorRelax/calm/sounds/ocean.mp3"></audio>
              </li>`;
...
oceanbtn.addEventListener('click', () => {
  document.body.style.backgroundImage = "url('../StudyorRelax/calm/calm_pic/ocean-back.gif')"; 
})
...
function birdloadMusic(){
  ...
  birdmainAudio.src = `../StudyorRelax/calm/sounds/birds.mp3`;
}
...
for (let i = 0; i < 1; i++) {
  ...
  let birdliTag = `<li li-index="${i + 1}">
                ...
                <audio class="bird" src="../StudyorRelax/calm/sounds/birds.mp3"></audio>
              </li>`;
...
birdbtn.addEventListener('click', () => {
  document.body.style.backgroundImage = "url('../StudyorRelax/calm/calm_pic/birds-back.gif')"; 
})
