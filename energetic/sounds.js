...
function thunderloadMusic(indexNumb){
  ...
  thundermainAudio.src = `sounds/thunder.mp3`;
}
...
thunderplayPauseBtn.addEventListener("click", ()=>{
  ...
  //   thunderpauseMusic();
  //   document.body.style.backgroundImage = "url('../energetic_pic/med-back.gif')"; 
  // } else {
  //   thunderplayMusic();
  //   document.body.style.backgroundImage = "url('../energetic_pic/thunder-back.gif')"; 
  // }
...
for (let i = 0; i < 1; i++) {
  ...
  let thunderliTag = `<li li-index="${i + 1}">
                ...
                <audio class="thunder" src="sounds/thunder.mp3"></audio>
              </li>`;
...
thunderbtn.addEventListener('click', () => {
  document.body.style.backgroundImage = "url('../AnimeForHumanity/energetic_pic/thunder-back.gif')"; 
})
...
function cityloadMusic(){
  ...
  citymainAudio.src = `sounds/city.mp3`;
}
...
cityplayPauseBtn.addEventListener("click", ()=>{
  ...
  // } else {
  //   cityplayMusic();
  //   document.body.style.backgroundImage = "url('../energetic_pic/city-back.gif')"; 
  // }
...
for (let i = 0; i < 1; i++) {
  ...
  let cityliTag = `<li li-index="${i + 1}">
                ...
                <audio class="city" src="sounds/city.mp3"></audio>
              </li>`;
...
citybtn.addEventListener('click', () => {
  document.body.style.backgroundImage = "url('../AnimeForHumanity/energetic_pic/city-back.gif')"; 
})
...
function oceanloadMusic(){
  ...
  oceanmainAudio.src = `sounds/ocean.mp3`;
}
...
oceanplayPauseBtn.addEventListener("click", ()=>{
  ...
  // } else {
  //    oceanplayMusic();
  //    document.body.style.backgroundImage = "url('../energetic_pic/ocean-back.gif')"; 
  // }
...
for (let i = 0; i < 1; i++) {
  ...
  let oceanliTag = `<li li-index="${i + 1}">
                ...
                <audio class="ocean" src="sounds/ocean.mp3"></audio>
              </li>`;
...
oceanbtn.addEventListener('click', () => {
  document.body.style.backgroundImage = "url('../AnimeForHumanity/energetic_pic/ocean-back.gif')"; 
})
...
function birdloadMusic(){
  ...
  birdmainAudio.src = `sounds/birds.mp3`;
}
...
birdplayPauseBtn.addEventListener("click", ()=>{
  ...
  // } else {
  //   birdplayMusic();
  //   document.body.style.backgroundImage = "url('../energetic_pic/birds-back.gif')"; 
  // }
...
for (let i = 0; i < 1; i++) {
  ...
  let birdliTag = `<li li-index="${i + 1}">
                ...
                <audio class="bird" src="sounds/birds.mp3"></audio>
              </li>`;
...
birdbtn.addEventListener('click', () => {
  document.body.style.backgroundImage = "url('../AnimeForHumanity/energetic_pic/birds-back.gif')"; 
})
