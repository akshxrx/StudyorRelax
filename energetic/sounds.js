...
cityplayPauseBtn.addEventListener("click", ()=>{
  ...
  // } else {
  //   cityplayMusic();
  //   document.body.style.backgroundImage = "url('../energetic/energetic_pic/city-back.gif')"; 
  // }
...
oceanplayPauseBtn.addEventListener("click", ()=>{
  ...
  // } else {
  //    oceanplayMusic();
  //    document.body.style.backgroundImage = "url('../energetic/energetic_pic/ocean-back.gif')"; 
  // }
...
birdplayPauseBtn.addEventListener("click", ()=>{
  ...
  // } else {
  //   birdplayMusic();
  //   document.body.style.backgroundImage = "url('../energetic/energetic_pic/birds-back.gif')"; 
  // }
