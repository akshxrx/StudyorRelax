...
oceanplayPauseBtn.addEventListener("click", () => {
  ...
  // if (oceanisMusicPlay) {
  //    oceanpauseMusic();
  //    document.body.style.backgroundImage = "url('../focused/focused_pic/med-back.gif')";
  // } else {
  //    oceanplayMusic();
  //    document.body.style.backgroundImage = "url('../focused/focused_pic/ocean-back.gif')";
  // }
...
birdplayPauseBtn.addEventListener("click", () => {
  ...
  // } else {
  //   birdplayMusic();
  //   document.body.style.backgroundImage = "url('../focused/focused_pic/birds-back.gif')";
  // }
